...
void Update(float deltaTime)
{
	...
	//CODE FOR MOVEMENT, NOT WORKING SO COMMENTED OUT
...
void Render()
{
    ...
    // these colors
    glm::vec3 colors[5] = { glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 1.0f), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.5f, 0.0f, 1.0f), glm::vec3(0.0f, 0.5f, 1.0f) };
    ...
    for (int i = 0; i < 5; i++)
    {
		...
		glm::mat4 scaling = glm::scale(identity, glm::vec3((i+0.5)*0.5, 0.5f, 0.5f));
		glm::mat4 rotation = glm::rotate(identity, 10.0f, glm::vec3(0.0f, 0.0f, DEG2RAD(30)));
		//glm::mat4 modelMatrix = (translation * rotation * scaling;

		modelMatrix = glm::translate(glm::mat4(1.0f), glm::vec3((i * 2.5f) - 4.5f, 0.0f, 0.0f)) * rotation * scaling;
